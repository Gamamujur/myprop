...
<html class="no-js" lang="">
  <head>
    ...
    <link rel="apple-touch-icon" href="{{ url('/frontend/images/content/icon8.png') }}" />
    <!-- Place favicon.ico in the root directory -->

    {{-- <link rel="stylesheet" href="{{ url('/frontend/css/main.css') }}" /> --}}
    <link rel="icon" href="{{ url('/frontend/images/content/icon8.png') }}" />

    <meta name="theme-color" content="#000" />
  <link rel="icon" href="{{ url('/frontend/images/content/icon9.png') }}">
