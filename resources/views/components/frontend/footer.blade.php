...
<section class="">
    <div class="border-t border-b border-gray-200 py-12 mt-16 px-4">
      <div class="flex justify-center mb-8">
        <img width="200"
          src="{{ url('/frontend/images/content/myprop2.png') }}"
        />
      </div>
      <aside class="container mx-auto">
        <div class="flex flex-wrap -mx-4 justify-center">
          ...
          <div class="px-4 w-full md:w-3/12 mb-4 md:mb-0">
            <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto explicabo ab magni qui ducimus. Porro corporis impedit officia fugiat delectus.</h1>
  ...
  <footer class="flex text-center px-4 py-8 justify-center">
    <p class="text-sm">
      Copyright 2021 • All Rights Reserved <br> MyProp by Gama
    </p>
  </footer>
  <!-- END: FOOTER -->