          ...
          <div class="flex flex-stretch items-center">
            ...
            <div class="w-auto">
              ...
              >
                ...
                <li class="mx-3 py-6 md:py-0">
                  <a href="#offer" class="text-black {{ \Route::current()->getname() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline"
                    >Special</a>
                </li>
                @auth
                {{-- <li class="mx-3 py-6 md:py-0">
                ...
                <li class="mx-3 py-6 md:py-0">
                  <form action="{{ route('logs') }}" method="POST">
                    @csrf
                  <button type="submit" class="text-black {{ \Route::current()->getname() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline"
                    >Logout</button>
                  </form>
                </li>
                @endauth
