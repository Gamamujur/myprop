        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                    ...
                    <form action="{{ route('dashboard.transaction.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Edit Status</label>
                            ...
                            <div class="w-full px-3 mt-10">
                                <button type="submit" class="bg-green-400 hover:bg-green-700 px-2 py-2 rounded shadow-lg text-white font-bold">Update Status</button>
                            </div>
                        </div>
