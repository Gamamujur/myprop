...
@section('content')
    ...
    <section class="flex items-center hero">
        ...
        >
          <h1 class="text-3xl md:text-5xl leading-tight font-semibold text-white">
            Provide Stuff <br class="" />of Your Dreams
          </h1>
          <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
            We provide high quality items for your home interior
            <br class="hidden lg:block" />to make you living your dreams
          </h2>
          <div>
            <a
        ...
        <div class="container mx-auto">
          <div class="flex flex-start mb-4">
            <h3 class="text-2xl capitalize font-semibold">
              Find your <br class="" />desired goods
            </h3>
          </div>
          <div class="grid grid-rows-2 grid-cols-9 gap-4">
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="/frontend/images/content/office.jpg"
                  alt=""
              ...
              >
                <h5 class="text-lg font-semibold">Office Room</h5>
            ...
            >
              <div class="card-shadow rounded-xl">
                <img
                  src="/frontend/images/content/bed.jpg"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
            ...
            <div class="relative col-span-9 row-span-1 md:col-span-4 card">
              <div class="card-shadow rounded-xl">
                <img
                  src="/frontend/images/content/kitchen.jpg"
                  alt=""
                  class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
                />
              </div>
              <div
                class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72"
              >
                <h5 class="text-lg font-semibold">Kitchen</h5>
      ...
      <!-- START: JUST ARRIVED -->
      <section class="flex flex-col py-16" id="offer">
